...
TEST(PruebasNodo, sonArbolesDuplicados)
{
    ...
    n1 = new Ñ::Nodo();
    n2 = new Ñ::Nodo();
    n3 = (Ñ::Nodo*)(new Ñ::Primario());
    n4 = (Ñ::Nodo*)(new Ñ::Primario());
    n1->ramas.push_back(n3);
    EXPECT_FALSE(Ñ::sonÁrbolesDuplicados(n1, n2));
    n2->ramas.push_back(n4);
    EXPECT_TRUE(Ñ::sonÁrbolesDuplicados(n1, n2));
    ...
    n3 = (Ñ::Nodo*)(new Ñ::Primario());
    n4 = (Ñ::Nodo*)(new Ñ::Primario());
    ((Ñ::Primario*)n3)->primario = "prueba";
    ((Ñ::Primario*)n4)->primario = "prueba";
    n1->ramas.push_back(n3);
    EXPECT_FALSE(Ñ::sonÁrbolesDuplicados(n1, n2));
    n2->ramas.push_back(n4);
    EXPECT_TRUE(Ñ::sonÁrbolesDuplicados(n1, n2));
    ...
    n3 = (Ñ::Nodo*)(new Ñ::LlamaFunción());
    n4 = (Ñ::Nodo*)(new Ñ::LlamaFunción());
    ((Ñ::LlamaFunción*)n3)->nombre = "prueba";
    ((Ñ::LlamaFunción*)n4)->nombre = "prueba";
    n1->ramas.push_back(n3);
    EXPECT_FALSE(Ñ::sonÁrbolesDuplicados(n1, n2));
    n2->ramas.push_back(n4);
    EXPECT_TRUE(Ñ::sonÁrbolesDuplicados(n1, n2));
...
TEST(PruebasNodo, duplicaArbol)
{
    ...
    n1 = new Ñ::Nodo();
    n2 = (Ñ::Nodo*)(new Ñ::Primario());
    ((Ñ::Primario*)n2)->primario = "prueba";
    n1->ramas.push_back(n2);
    r = Ñ::duplicaÁrbol(n1);
    EXPECT_TRUE(Ñ::sonÁrbolesDuplicados(n1, r));
    delete r, n2, n1;
    ...
    ((Ñ::LlamaFunción*)n2)->nombre = "prueba";
    n1->ramas.push_back(n2);
    r = Ñ::duplicaÁrbol(n1);
    EXPECT_TRUE(Ñ::sonÁrbolesDuplicados(n1, r));
    delete r, n2, n1;
