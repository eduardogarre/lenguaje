...
Ñ::Resultado Ñ::aBooleano(Ñ::Valor *valor)
{
	...
	{
		delete v;
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a bool.");
		return resultado;
	}
}
...
Ñ::Resultado Ñ::aNat8(Ñ::Valor *valor)
{
	...
	{
		delete v;
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a nat8.");
		return resultado;
	}
}
...
Ñ::Resultado Ñ::aNat16(Ñ::Valor *valor)
{
	...
	{
		delete v;
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a nat16.");
		return resultado;
	}
}
...
Ñ::Resultado Ñ::aNat32(Ñ::Valor *valor)
{
	...
	{
		delete v;
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a nat32.");
		return resultado;
	}
}
...
Ñ::Resultado Ñ::aNat64(Ñ::Valor *valor)
{
	...
	{
		delete v;
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a nat64.");
		return resultado;
	}
}
...
Ñ::Resultado Ñ::aEnt8(Ñ::Valor *valor)
{
	...
	{
		delete v;
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a ent8.");
		return resultado;
	}
}
...
Ñ::Resultado Ñ::aEnt16(Ñ::Valor *valor)
{
	...
	{
		delete v;
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a ent16.");
		return resultado;
	}
}
...
Ñ::Resultado Ñ::aEnt32(Ñ::Valor *valor)
{
	...
	{
		delete v;
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a ent32.");
		return resultado;
	}
}
...
Ñ::Resultado Ñ::aEnt64(Ñ::Valor *valor)
{
	...
	{
		delete v;
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a ent64.");
		return resultado;
	}
}
...
Ñ::Resultado Ñ::aPuntero(Ñ::Valor *valor)
{
	...
	if (valor->esPuntero())
	{
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a puntero.");
		return resultado;
	}
...
Ñ::Resultado Ñ::aReal32(Ñ::Valor *valor)
{
	...
	{
		delete v;
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a real32.");
		return resultado;
	}
}
...
Ñ::Resultado Ñ::aReal64(Ñ::Valor *valor)
{
	...
	{
		delete v;
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a real64.");
		return resultado;
	}
}
...
Ñ::Resultado Ñ::aTexto(Ñ::Valor *valor)
{
	...
	{
		delete v;
		resultado.error("CONVERSIÓN DE TIPOS - No está permitida la conversión de " + Ñ::obténNombreDeTipo(obténTipoDeValor(valor)) + " a texto.");
		return resultado;
	}
}
