...
Ñ::CategoríaTipo Ñ::obténTipoMínimoComún(Ñ::Valor* valor1, Ñ::Valor* valor2)
{
	if(valor1 == nullptr || valor2 == nullptr)
	{
		return Ñ::CategoríaTipo::TIPO_NADA;
	}
	else if(((Ñ::Nodo*)valor1)->categoría != Ñ::CategoríaNodo::NODO_VALOR || ((Ñ::Nodo*)valor2)->categoría != Ñ::CategoríaNodo::NODO_VALOR)
	{
		return Ñ::CategoríaTipo::TIPO_NADA;
	}

	Ñ::CategoríaTipo t1 = valor1->obténTipo();
	Ñ::CategoríaTipo t2 = valor1->obténTipo();
	Ñ::CategoríaTipo t;
...
bool Ñ::comparaValores(Ñ::Valor* valor1, Ñ::Valor* valor2)
{
	...
	Ñ::CategoríaTipo tmc = obténTipoMínimoComún(valor1, valor2);
